...
from reference import style_dict, color_dict, label_item_dict
...
class ItemClassifier:
    ...
    def initialize_model(self):
        ...
        checkpoint = torch.load(
            "./cloth_model/weight/model_best.pt", map_location=self.device)
    ...
    def rembg(self, img):
        ...
        org_image = cv2.imdecode(np.frombuffer(
    ...
    def item_predict(self, image_data):
        ...
        print("Predicted item :", label_item_dict[predicted_item_str])
    ...
    def style_predict(self, style):
        ...
        print("Selected style :", style)  # acensia
...
class ColorClassifier:
    ...
    def color_predict(self, image_data, mask_data):  # image_data 에 mask img만 들어왔음 acensia
        ...
        print("Predicted color :", p1)  # acensia
